...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.SPECIES_SAVE).permitAll()
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.BREED_SAVE).permitAll()
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.CONDUCT_RULE_SAVE).permitAll()
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.HELP_PAGE_SAVE).permitAll()
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.SERVICE_TYPE_SAVE).permitAll()
                ...
                .antMatchers(ApiPaths.PARAM_ENDPOINTS_URL+ApiPaths.PET_CARE_SAVE).permitAll()
